    ...
    'use strict';
  	...
  	AutoComplete.prototype = {
      	...
      	select: function (item) {
         	this.editor.focus();
          	var selection = this.editor.dom.select('span#autocomplete-delimiter')[0];
      	...
      	cleanUp: function (rollback) {
          	...
          	if (rollback) {
              	var text = this.query,
                  	$selection = $(this.editor.dom.select('span#autocomplete-delimiter'));
      	...
      	offset: function () {
          	var rtePosition = $(this.editor.getContainer()).offset(),
              	...
              	nodePosition = $(this.editor.dom.select('span#autocomplete-delimiter')).position();
      	...
      	offsetInline: function () {
          	var nodePosition = $(this.editor.dom.select('span#autocomplete-delimiter')).offset();
      	...
      	editor.on('keypress', function (e) {
        	...
        	if (delimiterIndex > -1 && prevCharIsSpace()) {
          		if (autoComplete === undefined || (autoComplete.hasFocus !== undefined && !autoComplete.hasFocus)) {
              		...
              		autoComplete = new AutoComplete(editor, Object.assign({}, autoCompleteData, { delimiter: autoCompleteData.delimiter[delimiterIndex] }));
          		}
          	}
      	});
